...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionCreators = __webpack_require__(178);
	...
	exports.default = (0, _reactRedux.connect)(stateToProps)(App);
...
/***/ function(module, exports) {
	...
	var START_BET = exports.START_BET = 'START_BET';
	var END_BET = exports.END_BET = 'END_BET';

	var startBet = exports.startBet = function startBet(letter) {
	  return {
	    type: START_BET,
	    letter: letter
	  };
	};
	var endBet = exports.endBet = function endBet(letter) {
	  return {
	    type: END_BET,
	    letter: letter
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bets = exports.bets = function bets() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? initState.bets : arguments[0];
